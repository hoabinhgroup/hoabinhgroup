...
$config = [
  ...
  'logs' => [
    "CURLOPT_URL" =>
      'https://investdata.vn/activity/log/responsive-file-manager',
    "created_at" => date('d/m/Y H:i:s', time()),
    "action_id" => $_SESSION['info']['member']['id'],
    "action_name" => $_SESSION['info']['member']['username'],
...
return array_merge($config, [
  ...
  'tui_defaults_config' => [
    ...
    'submenu.normalLabel.fontWeight' =>
      $config['submenu.normalLabel.fontWeight'],
