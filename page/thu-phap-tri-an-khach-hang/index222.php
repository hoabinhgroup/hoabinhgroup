...
<head>
	...
	<title>Tặng tranh thư pháp nhân dịp tết 2020</title>
  ...
  $('[data-toggle="tooltip"]').tooltip()
	...
	$(".used_service").on('click',function(){
		...
		if($(this).val() == 1){
			...
			$("#service").addClass('always-validate');
			$("#calitext").addClass('always-validate');
		/*	$("#service").attr('data-msg-required', "Bắt buộc");
			...
			*/
			...
			$("#service").removeClass('always-validate');
			$("#calitext").removeClass('always-validate');
			//$("#service-error").hide();
			//$("#calitext-error").hide();
